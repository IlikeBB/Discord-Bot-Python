...
class Main(Cog_Extension):
    ...
    async def 指令(self, ctx):
        ...
        embed.add_field(name = f"Game指令", inline=False, value="「$game」開啟Game help")
        embed.add_field(name = "噁心部份人指令(尚未實裝)", inline=False, value="「${會員名字}」e.g. $阿布")
        embed.add_field(name = "相親相愛image(尚未實裝)", inline=False, value="「${user}x{user}」e.g. $阿布x右手")
